...
public class CartServlet extends HttpServlet {
    ...
    public String getRowData(Cart cart) {
        ...
        return "    <tr>\r\n"
                ...
                + "          <button type='submit' name='removeFromCart' class='btn btn-outline-danger btn-sm mx-1 rounded-circle'>\r\n"
                + "            <i class='bi bi-dash-lg'></i>\r\n"
                + "          </button>\r\n"
                + "          <span class='fw-bold px-2'>" + cart.getQuantity() + "</span>\r\n"
                + "          <button type='submit' name='addToCart' class='btn btn-outline-success btn-sm mx-1 rounded-circle'>\r\n"
